...
class FavoritesScreen extends StatefulWidget {
  ...
  const FavoritesScreen({super.key, required this.isDarkMode, required this.onTrackSelected});
  ...
  Future<void> _loadFavorites() async {
    ...
    for (String jsonStr in favsJson) {
      try {
        ...
        loadedTracks.add(Track.fromLocalJson(trackMap));
      } catch (e) {
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  leading: Icon(Icons.favorite, color: isSelected ? Colors.white : (widget.isDarkMode ? Colors.white70 : Colors.black87)),
                  title: Text(
                    track.title,
                    maxLines: 1,
